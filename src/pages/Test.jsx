  ...
  const questions = [
    {
      id: 1,
      type: 'text',
      questionText: "Чи є у вас якась звичка, яка може бути незвичною/дратівливою для інших?",
    ...
    },
    {
      ...
      options: [
        ...
        { id: '2.2', text: "Дрібниці (сіль, цукор, мило) можна ділити, більшість — ні." },
    ...
    },
    {
      id: 3,
      type: 'radio',
      questionText: "Як ви ставитеся до накопичення особистих речей та одягу у кімнаті?",
      options: [
        { id: '3.1', text: "Мінімаліст: Не люблю зайвого." },
        { id: '3.2', text: "Практик: Зберігаю лише необхідне." },
        { id: '3.3', text: "Колекціонер: Мені потрібен простір для своїх речей." }
      ]
    },
    {
        id: 4,
